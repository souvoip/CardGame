...
public class CardItem2 : MonoBehaviour, IPointerMoveHandler, IPointerExitHandler, IPointerDownHandler
{
    /// <summary>  
    /// 卡牌扇形展开中心点  
    /// </summary>  
    ...
    private UnityAction<CardItem2> onMouseDown;
    ...
    public void Init(UnityAction<CardItem2> onMouseMoveIn, UnityAction onMouseMoveOut, UnityAction<CardItem2> onMouseDown)
    {
